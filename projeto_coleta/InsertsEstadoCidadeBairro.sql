...
-- insert bairros 
insert into tb_bairro(nome,fk_cidade) values

	 ('Aarão Reis',1630),
	 ('Acaba Mundo',1630),
	 ('Acaiaca',1630),
	 ('Ademar Maldonado',1630),
	 ('Aeroporto',1630),
	 ('Aguas Claras',1630),
	 ('Alípio de Melo',1630),
	 ('Alpes',1630),
	 ('Alta Tensão 1ª Seção',1630),
	 ('Alta Tensão 2ª Seção',1630),

	 ('Alto Barroca',1630),
	 ('Alto Caiçaras',1630),
	 ('Alto das Antenas',1630),
	 ('Alto dos Pinheiros',1630),
	 ('Alto Vera Cruz',1630),
	 ('Álvaro Camargos',1630),
	 ('Ambrosina',1630),
	 ('Anchieta',1630),
	 ('Andiroba',1630),
	 ('Antonio Ribeiro de Abreu 1ª Seção',1630),

	 ('Antonio Ribeiro de Abreu 2ª Seção',1630),
	 ('Antonio Ribeiro de Abreu 3ª Seção',1630),
	 ('Aparecida',1630),
	 ('Aparecida 7ª Seção',1630),
	 ('Ápia',1630),
	 ('Apolonia',1630),
	 ('Araguaia',1630),
	 ('Atila de Paiva',1630),
	 ('Bacurau',1630),
	 ('Bairro das Indústrias II',1630),

	 ('Baleia',1630),
	 ('Bandeirantes',1630),
	 ('Barão Homem de Melo 1ª Seção',1630),
	 ('Barão Homem de Melo 2ª Seção',1630),
	 ('Barão Homem de Melo 3ª Seção',1630),
	 ('Barreiro',1630),
	 ('Barro Preto',1630),
	 ('Barroca',1630),
	 ('Beija Flor',1630),
	 ...
	 ('Biquinhas',1630),
	 ('Boa Esperança',1630),
	 ('Boa União 1ª Seção',1630),
	 ('Boa União 2ª seção',1630),
	 ('Boa Viagem',1630),
	 ...
	 ('Bonfim',1630),
	 ('Bonsucesso',1630),
	 ('Brasil Industrial',1630),
	 ('Braúnas',1630),
	 ('Buraco Quente',1630),
	 ('Buritis',1630),
	 ('Cabana do Pai Tomás',1630),
	 ('Cachoeirinha',1630),

	 ('Caetano Furquim',1630),
	 ('Caiçara - Adelaide',1630),
	 ('Caiçaras',1630),
	 ('Calafate',1630),
	 ('Califórnia',1630),
	 ('Camargos',1630),
	 ('Campo Alegre',1630),
	 ('Camponesa 1ª seção',1630),
	 ('Camponesa 2ª Seção',1630),
	 ('Campos UFMG',1630),

	 ('Canaa',1630),
	 ('Canadá',1630),
	 ('Candelaria',1630),
	 ('Capitão Eduardo',1630),
	 ('Cardoso',1630),
	 ('Carlos Prates',1630),
	 ('Carmo',1630),
	 ('Casa Branca',1630),
	 ...
	 ('Centro',1630),
	 ('Céu Azul',1630),
	 ('Chácara Leonina',1630),
	 ('Cidade Jardim',1630),
	 ('Cidade Jardim Taquaril',1630),
	 ('Cidade Nova',1630),
	 ('Cinquentenário',1630),
	 ('Colégio Batista',1630),

	 ('Comiteco',1630),
	 ('Concórdia',1630),
	 ('Cônego Pinheiro 1ª Seção',1630),
	 ('Cônego Pinheiro 2ª Seção',1630),
	 ('Confisco',1630),
	 ('Conjunto Bonsucesso',1630),
	 ('Conjunto Califórnia I',1630),
	 ('Conjunto Califórnia II',1630),
	 ('Conjunto Capitão Eduardo',1630),
	 ('Conjunto Celso Machado',1630),

	 ('Conjunto Floramar',1630),
	 ('Conjunto Jardim Filadélfia',1630),
	 ('Conjunto Jatoba',1630),
	 ('Conjunto Lagoa',1630),
	 ('Conjunto Minas Caixa',1630),
	 ('Conjunto Novo Dom Bosco',1630),
	 ('Conjunto Paulo VI',1630),
	 ('Conjunto Providencia',1630),
	 ('Conjunto Santa Maria',1630),
	 ('Conjunto São Francisco de Assis',1630),

	 ('Conjunto Serra Verde',1630),
	 ('Conjunto Taquaril',1630),
	 ('Copacabana',1630),
	 ('Coqueiros',1630),
	 ('Coração de Jesus',1630),
	 ('Coração Eucarístico',1630),
	 ('Corumbiara',1630),
	 ('Cruzeiro',1630),
	 ('Custodinha',1630),
	 ('das Indústrias I',1630),

	 ('Delta',1630),
	 ('Diamante',1630),
	 ('Distrito Industrial do Jatoba',1630),
	 ('Dom Bosco',1630),
	 ('Dom Cabral',1630),
	 ('Dom Joaquim',1630),
	 ('Dom Silverio',1630),
	 ('Dona Clara',1630),
	 ('Embaúbas',1630),
	 ('Engenho Nogueira',1630),

	 ('Ermelinda',1630),
	 ('Ernesto Nascimento',1630),
	 ('Esperança',1630),
	 ('Esplanada',1630),
	 ('Estoril',1630),
	 ('Estrela',1630),
	 ('Estrela do Oriente',1630),
	 ('Etelvina Carneiro',1630),
	 ('Europa',1630),
	 ('Eymard',1630),
	 ...
	 ('Fernão Dias',1630),
	 ('Flamengo',1630),
	 ('Flavio de Oliveira',1630),
	 ('Flavio Marques Lisboa',1630),
	 ('Floramar',1630),
	 ('Floresta',1630),
	 ('Frei Leopoldo',1630),
	 ('Funcionários',1630),
	 ...
	 ('Jaqueline',1630),
	 ('Jaraguá',1630),
	 ('Jardim Alvorada',1630),
	 ('Jardim América',1630),
	 ('Jardim Atlântico',1630),

	 ('Jardim do Vale',1630),
	 ('Jardim dos Comerciarios',1630),
	 ('Jardim Felicidade',1630),
	 ('Jardim Guanabara',1630),
	 ('Jardim Leblon',1630),
	 ('Jardim Montanhês',1630),
	 ('Jardim São José',1630),
	 ('Jardim Vitoria',1630),
	 ('Jardinópolis',1630),
	 ('Jatobá',1630),
	 ...
	 ('Juliana',1630),
	 ('Lagoa',1630),
	 ('Lagoa da Pampulha',1630),
	 ('Lagoinha',1630),
	 ('Lagoinha Leblon',1630),
	 ('Lajedo',1630),
	 ...
	 ('Maria Tereza',1630),
	 ('Maria Virgínia',1630),
	 ('Mariano de Abreu',1630),
	 ('Marieta 1ª Seção',1630),
	 ('Marieta 2ª Seção',1630),
	 ('Marieta 3ª Seção',1630),
	 ('Marilandia',1630),
	 ('Mariquinhas',1630),
	 ('Marmiteiros',1630),
	 ('Milionario',1630),
	 ...
	 ('Mirante',1630),
	 ('Mirtes',1630),
	 ('Monsenhor Messias',1630),
	 ('Monte Azul',1630),
	 ('Monte São José',1630),

	 ('Morro dos Macacos',1630),
	 ('Nazare',1630),
	 ('Nossa Senhora Aparecida',1630),
	 ('Nossa Senhora da Aparecida',1630),
	 ('Nossa Senhora da Conceição',1630),
	 ('Nossa Senhora de Fátima',1630),
	 ('Nossa Senhora do Rosário',1630),
	 ('Nova America',1630),
	 ('Nova Cachoeirinha',1630),
	 ('Nova Cintra',1630),
	 ...
	 ('Nova Suíça',1630),
	 ('Nova Vista',1630),
	 ('Novo Aarão Reis',1630),
	 ('Novo das Industrias',1630),
	 ('Novo Glória',1630),

	 ('Novo Ouro Preto',1630),
	 ('Novo Santa Cecilia',1630),
	 ('Novo São Lucas',1630),
	 ('Novo Tupi',1630),
	 ('Oeste',1630),
	 ('Olaria',1630),
	 ...
	 ('Paquetá',1630),
	 ('Paraíso',1630),
	 ('Parque São José',1630),
	 ('Parque São Pedro',1630),
	 ('Paulo VI',1630),
	 ('Pedreira Padro Lopes',1630),
	 ('Penha',1630),
	 ...
	 ('Pousada Santo Antonio',1630),
	 ('Prado',1630),
	 ('Primeiro de Maio',1630),
	 ('Providencia',1630),
	 ('Renascença',1630),
	 ('Ribeiro de Abreu',1630),
	 ('Rio Branco',1630),
	 ('Sagrada Família',1630),
	 ('Salgado Filho',1630),
	 ('Santa Amelia',1630),
	 ...
	 ('Santa Isabel',1630),
	 ('Santa Lúcia',1630),
	 ('Santa Margarida',1630),
	 ('Santa Maria',1630),

	 ('Santa Monica',1630),
	 ('Santa Rita',1630),
	 ('Santa Rita de Cássia',1630),
	 ('Santa Rosa',1630),
	 ('Santa Sofia',1630),
	 ('Santa Tereza',1630),
	 ('Santa Terezinha',1630),
	 ('Santana do Cafezal',1630),
	 ('Santo Agostinho',1630),
	 ('Santo André',1630),
	 ...
	 ('São Damião',1630),
	 ('São Francisco',1630),
	 ('São Francisco das Chagas',1630),
	 ('São Gabriel',1630),
	 ('São Geraldo',1630),

	 ('São Gonçalo',1630),
	 ('São João',1630),
	 ('São João Batista',1630),
	 ('São Jorge 1ª Seção',1630),
	 ('São Jorge 2ª Seção',1630),
	 ('São Jorge 3ª Seção',1630),
	 ('São José',1630),
	 ('São Lucas',1630),
	 ('São Luiz',1630),
	 ('São Marcos',1630),
	 ...
	 ('Saudade',1630),
	 ('Savassi',1630),
	 ('Senhor dos Passos',1630),

	 ('Serra',1630),
	 ('Serra do Curral',1630),
	 ('Serra Verde',1630),
	 ('Serrano',1630),
	 ('Silveira',1630),
	 ('Sion',1630),
	 ('Solar do Barreiro',1630),
	 ('Solimoes',1630),
	 ('Sport Club',1630),
	 ('Sumaré',1630),
	 ...
	 ('Urca',1630),
	 ('Vale do Jatoba',1630),
	 ('Varzea da Palma',1630),
	 ('Venda Nova',1630),
	 ('Ventosa',1630),
	 ('Vera Cruz',1630),

	 ('Vila Aeroporto',1630),
	 ('Vila Aeroporto Jaraguá',1630),
	 ('Vila Antena',1630),
	 ('Vila Antena Montanhês',1630),
	 ('Vila Atila de Paiva',1630),
	 ('Vila Bandeirantes',1630),
	 ('Vila Barragem Santa Lúcia',1630),
	 ('Vila Batik',1630),
	 ('Vila Betânia',1630),
	 ('Vila Boa Vista',1630),

	 ('Vila Calafate',1630),
	 ('Vila Califórnia',1630),
	 ('Vila Canto do Sabiá',1630),
	 ('Vila Cemig',1630),
	 ('Vila Cloris',1630),
	 ('Vila Copacabana',1630),
	 ('Vila Copasa',1630),
	 ('Vila Coqueiral',1630),
	 ('Vila da Amizade',1630),
	 ('Vila da Ária',1630),

	 ('Vila da Luz',1630),
	 ('Vila da Paz',1630),
	 ('Vila das Oliveiras',1630),
	 ('Vila de Sá',1630),
	 ('Vila do Pombal',1630),
	 ('Vila dos Anjos',1630),
	 ('Vila Ecológica',1630),
	 ('Vila Engenho Nogueira',1630),
	 ('Vila Esplanada',1630),
	 ('Vila Formosa',1630),

	 ('Vila Fumec',1630),
	 ('Vila Havaí',1630),
	 ('Vila Independencia 1ª Seção',1630),
	 ('Vila Independencia 2ª Seção',1630),
	 ('Vila independencia 3ª Seção',1630),
	 ('Vila Inestan',1630),
	 ('Vila Ipiranga',1630),
	 ('Vila Jardim Alvorada',1630),
	 ('Vila Jardim Leblon',1630),
	 ('Vila Jardim Montanhes',1630),

	 ('Vila Jardim São José',1630),
	 ('Vila Madre Gertrudes 1ª Seção',1630),
	 ('Vila Madre Gertrudes 2ª Seção',1630),
	 ('Vila Madre Gertrudes 3ª Seção',1630),
	 ('Vila Madre Gertrudes 4ª Seção',1630),
	 ('Vila Maloca',1630),
	 ('Vila Mangueiras',1630),
	 ('Vila Mantiqueira',1630),
	 ('Vila Maria',1630),
	 ('Vila Minaslandia',1630),

	 ('Vila Nossa Senhora do Rosário',1630),
	 ('Vila Nova',1630),
	 ('Vila Nova Cachoeirinha 1ª Seção',1630),
	 ('Vila Nova Cachoeirinha 2ª Seção',1630),
	 ('Vila Nova Cachoeirinha 3ª Seção',1630),
	 ('Vila Nova dos Milionarios',1630),
	 ('Vila Nova Gameleira 1ª Seção',1630),
	 ('Vila Nova Gameleira 2ª Seção',1630),
	 ('Vila Nova Gameleira 3ª Seção',1630),
	 ('Vila Nova Paraíso',1630),

	 ('Vila Novo São Lucas',1630),
	 ('Vila Oeste',1630),
	 ('Vila Olhos D''Água',1630),
	 ('Vila Ouro Minas',1630),
	 ('Vila Paquetá',1630),
	 ('Vila Paraíso',1630),
	 ('Vila Paris',1630),
	 ('Vila Petropolis',1630),
	 ('Vila Pilar',1630),
	 ('Vila Pinho',1630),

	 ('Vila Piratininga',1630),
	 ('Vila Piratininga Venda Nova',1630),
	 ('Vila Primeiro de Maio',1630),
	 ('Vila Puc',1630),
	 ('Vila Real 1ª Seção',1630),
	 ('Vila Real 2ª Seção',1630),
	 ('Vila Rica',1630),
	 ('Vila Santa Monica 1ª Seção',1630),
	 ('Vila Santa Monica 2ª Seção',1630),
	 ('Vila Santa Rosa',1630),

	 ('Vila Santo Antônio',1630),
	 ('Vila Santo Antônio Barroquinha',1630),
	 ('Vila São Dimas',1630),
	 ('Vila São Francisco',1630),
	 ('Vila São Gabriel',1630),
	 ('Vila São Gabriel Jacui',1630),
	 ('Vila São Geraldo',1630),
	 ('Vila São João Batista',1630),
	 ('Vila São Paulo',1630),
	 ('Vila São Rafael',1630),

	 ('Vila Satélite',1630),
	 ('Vila SESC',1630),
	 ('Vila Sumaré',1630),
	 ('Vila Suzana Primeira Seção',1630),
	 ('Vila Suzana Segunda Seção',1630),
	 ('Vila Tirol',1630),
	 ('Vila Trinta e Um de Março',1630),
	 ('Vila União',1630),
	 ('Vila Vista Alegre',1630),
	 ('Virgínia',1630),

	 ('Vista Alegre',1630),
	 ('Vista do Sol',1630),
	 ('Vitoria',1630),
	 ('Vitoria da Conquista',1630),
	 ('Xangri-lá',1630),
	 ('Xodo-Marize',1630),
	 ('Zilah Sposito',1630),
	 ('Altinópolis',1879),
	 ...
	 ('Castanheiras',1879),
	 ('Centro',1879),
	 ('Chácara Boa Sorte',1879),
	 ('Chácaras Braúnas',1879),
	 ('Chácaras Canaã',1879),
	 ('Chácaras Encosta do Sol',1879),

	 ('Chácaras Recanto da Cachoeira',1879),
	 ('Cidade Jardim',1879),
	 ('Cidade Nova',1879),
	 ('Conquista',1879),
	 ('Distrito Industrial',1879),
	 ('Elvamar',1879),
	 ('Esperança',1879),
	 ('Esplanada',1879),
	 ('Esplanadinha',1879),
	 ...
	 ('Fraternidade',1879),
	 ('Grã-Duquesa',1879),
	 ('Ilha dos Araújos',1879),
	 ('Jardim Alice',1879),
	 ('Jardim Alvorada',1879),
	 ('Jardim Atalaia',1879),
	 ('Jardim do Trevo',1879),
	 ('Jardim Ipê',1879),
	 ('Jardim Pérola',1879),
	 ('Jardim Primavera',1879),

	 ('Jardim Vera Cruz',1879),
	 ('Kennedy',1879),
	 ('Lagoa Santa',1879),
	 ('Lourdes',1879),
	 ('Mãe de Deus',1879),
	 ('Maria Eugênia',1879),
	 ('Morada do Acampamento',1879),
	 ('Morada do Vale',1879),
	 ('Morro do Querosene',1879),
	 ('Nossa Senhora das Graças',1879),

	 ('Nova Vila Bretas',1879),
	 ('Novo Horizonte',1879),
	 ('Palmeiras',1879),
	 ('Parque das Aroeiras',1879),
	 ('Penha',1879),
	 ('Planalto',1879),
	 ('Recanto das Garças',1879),
	 ('Residencial Figueiras',1879),
	 ('Retiro dos Lagos',1879),
	 ('Sagrada Família',1879),

	 ('Santa Helena',1879),
	 ('Santa Paula',1879),
	 ('Santa Rita',1879),
	 ('Santa Terezinha',1879),
	 ('Santo Agostinho',1879),
	 ('Santo Antônio',1879),
	 ('Santos Dumont',1879),
	 ('Santos Dumont II',1879),
	 ('São Cristóvão',1879),
	 ('São Geraldo',1879),
	 ...
	 ('Vila Bretas',1879),
	 ('Vila do Sol',1879),
	 ('Vila dos Montes',1879),
	 ('Vila Isa',1879),
	 ('Vila Mariana',1879),
	 ('Vila Mariquita',1879),
	 ('Vila Parque Ibituruna',1879),
	 ('Vila Rica',1879),
	 ('Village da Serra',1879),

	 ('Aeroporto',1983),
	 ('Alto dos Passos',1983),
	 ('Bairu',1983),
	 ('Barão do Retiro',1983),
	 ('Barbosa Lage',1983),
	 ('Barreira do Triunfo',1983),
	 ('Benfica',1983),
	 ('Boa Vista',1983),
	 ('Bom Pastor',1983),
	 ('Bomba de Fogo',1983),
	 ...
	 ('Cruzeiro de Santo Antônio',1983),
	 ('Dom Bosco',1983),
	 ('Eldorado',1983),
	 ('Esplanada',1983),
	 ('Fábrica',1983),
	 ('Floresta',1983),
	 ('Francisco Bernardino',1983),
	 ('Grajaú',1983),
	 ('Grambery',1983),
	 ('Graminha',1983),

	 ('Granjas Bethania',1983),
	 ('Industrial',1983),
	 ('Ipiranga',1983),
	 ('Jardim Bonclima',1983),
	 ('Jardim Glória',1983),
	 ('Jardim Natal',1983),
	 ('Jardim Paineiras',1983),
	 ('Jardim Santa Helena',1983),
	 ('Jóckey Club',1983),
	 ('Linhares',1983),

	 ('Manoel Honório',1983),
	 ('Mariano Procópio',1983),
	 ('Martelos',1983),
	 ('Meggliolário',1983),
	 ('Monte Castelo',1983),
	 ('Morro da Glória',1983),
	 ('Morro do Imperador',1983),
	 ('Muçunge da Grama',1983),
	 ('Mundo Novo',1983),
	 ('Nossa Senhora de Lourdes',1983),

	 ('Nova Califórnia',1983),
	 ('Nova Era',1983),
	 ('Novo Horizonte',1983),
	 ('Ozanan',1983),
	 ('Poço Rico',1983),
	 ...
	 ('Santa Efigênia',1983),
	 ('Santa Luzia',1983),
	 ('Santa Rita de Cássia',1983),
	 ('Santa Terezinha',1983),
	 ('Santo Antônio do Paraibuna',1983),
	 ('São Benedito',1983),
	 ('São Bernardo',1983),
	 ...
	 ('Teixeiras',1983),
	 ('Vale do Ipê',1983),
	 ('Vale dos Bandeirantes',1983),
	 ('Vila Furtado de Menezes',1983),
	 ('Vila Ideal',1983),
	 ('Vila Olavo Costa',1983),
	 ...
	 ('Cidade Bíblica',3591),
	 ('Colégio Naval',3591),
	 ('Encruzo da Enseada',3591),
	 ('Enseada',3591),
	 ('Enseada das Estrelas',3591),
	 ('Enseada das Palmas',3591),
	 ('Enseada do Sítio Forte',3591),

	 ('Frade',3591),
	 ('Freguesia de Santana',3591),
	 ('Gamboa do Belém',3591),
	 ('Gamboa do Bracuí',3591),
	 ('Garatucaia',3591),
	 ('Grataú',3591),
	 ('Guaxuma',3591),
	 ('Ilha Comprida',3591),
	 ...
	 ('Monte Castelo',3591),
	 ('Morro da Boa Vista',3591),
	 ('Morro da Caixa D''água',3591),
	 ('Morro da Carioca',3591),
	 ('Morro da Cruz',3591),
	 ('Morro da Fortaleza',3591),
	 ('Morro da Glória I',3591),
	 ('Morro da Glória II',3591),
	 ('Morro do Abel',3591),
	 ('Morro do Bulé',3591),

	 ('Morro do Carmo',3591),
	 ('Morro do Moreno',3591),
	 ('Morro do Perez',3591),
	 ('Morro do Santo Antonio',3591),
	 ('Morro do Tatu',3591),
	 ('Nova Angra',3591),
	 ('Paraíso',3591),
	 ('Parnaioca',3591),
	 ('Parque Belém',3591),
	 ('Parque das Palmeiras',3591),

	 ('Parque Mambucaba',3591),
	 ('Parque Perequê',3591),
	 ('Piraquara',3591),
	 ('Ponta da Cruz',3591),
	 ('Ponta da Ribeira',3591),
	 ('Ponta do Partido',3591),
	 ('Ponta do Sapê',3591),
	 ('Ponta dos Catelhanos',3591),
	 ('Ponta Leste',3591),
	 ('Pontal',3591),
	 ...
	 ('Portogalo',3591),
	 ('Praia Brava',3591),
	 ('Praia da Chácara',3591),
	 ('Praia da Longa',3591),
	 ('Praia da Ribeira',3591),
	 ('Praia das Goiabas',3591),
	 ('Praia do Anil',3591),
	 ('Praia do Jardim',3591),
	 ('Praia do Machado',3591),

	 ('Praia do Recife',3591),
	 ('Praia Grande',3591),
	 ('Praia Vermelha',3591),
	 ('Praia Vermelha da Ilha Grande',3591),
	 ('Provetá',3591),
	 ('Retiro',3591),
	 ('Santa Rita do Bracuí',3591),
	 ('Sapinhatuba I',3591),
	 ('Sapinhatuba III',3591),
	 ('Tanguá',3591),

	 ('Terminal da Petrobrás',3591),
	 ('Usina Nuclear',3591),
	 ('Verolme',3591),
	 ('Vila da Petrobrás',3591),
	 ('Vila do Abraão',3591),
	 ('Vila dos Pescadores',3591),
	 ('Vila Histórica de Mambucaba',3591),
	 ('Vila Velha',3591),
	 ('Village',3591),
	 ('Amapá',3615),

	 ('Bar dos Cavalheiros',3615),
	 ('Barro Branco',3615),
	 ('Campos Elíseos',3615),
	 ('Cângulo',3615),
	 ('Capivari',3615),
	 ('Centenário',3615),
	 ('Centro',3615),
	 ('Chácaras Arcampo',3615),
	 ('Chácaras Rio-Petrópolis',3615),
	 ('Cidade dos Meninos',3615),

	 ('Cidade Parque Paulista',3615),
	 ('Doutor Laureano',3615),
	 ('Figueira',3615),
	 ('Gramacho',3615),
	 ('Imbariê',3615),
	 ('Jardim Anhangá',3615),
	 ('Jardim Primavera',3615),
	 ('Lamarão',3615),
	 ('Mantiquira',3615),
	 ('Meio da Serra',3615),

	 ('Olavo Bilac',3615),
	 ('Parada Angélica',3615),
	 ('Parada Morabi',3615),
	 ('Parque Duque',3615),
	 ('Parque Eldorado',3615),
	 ('Parque Fluminense',3615),
	 ('Parque Sarapuí',3615),
	 ('Periquitos',3615),
	 ('Pilar',3615),
	 ('Santa Cruz da Serra',3615),
	 ...
	 ('Cubango',3638),
	 ('Engenho do Mato',3638),
	 ('Engenhoca',3638),
	 ('Fátima',3638),
	 ('Fonseca',3638),
	 ('Gragoatá',3638),
	 ('Icaraí',3638),
	 ('Ilha da Conceição',3638),
	 ('Ingá',3638),
	 ('Itacoatiara',3638),
	 ...
	 ('Jardim Imbuí',3638),
	 ('Jurujuba',3638),
	 ('Largo da Batalha',3638),
	 ('Maceió',3638),
	 ('Maravista',3638),
	 ('Maria Paula',3638),
	 ('Matapaca',3638),

	 ('Morro do Estado',3638),
	 ('Muriqui',3638),
	 ('Pé Pequeno',3638),
	 ('Piratininga',3638),
	 ('Ponta D''Areia',3638),
	 ...
	 ('Barra da Tijuca',3658),
	 ('Barra de Guaratiba',3658),
	 ('Barros Filho',3658),
	 ('Benfica',3658),
	 ('Bento Ribeiro',3658),
	 ('Bonsucesso',3658),
	 ...
	 ('Cidade de Deus',3658),
	 ('Cidade Nova',3658),
	 ('Cidade Universitária',3658),
	 ('Cocotá',3658),
	 ('Coelho Neto',3658),
	 ('Colégio',3658),
	 ('Complexo do Alemão',3658),
	 ('Copacabana',3658),
	 ('Cordovil',3658),
	 ('Cosme Velho',3658),
	 ...
	 ('Deodoro',3658),
	 ('Encantado',3658),
	 ('Engenheiro Leal',3658),
	 ('Engenho da Rainha',3658),
	 ('Engenho de Dentro',3658),
	 ('Engenho Novo',3658),

	 ('Estácio',3658),
	 ('Flamengo',3658),
	 ('Freguesia (Ilha do Governador)',3658),
	 ('Freguesia (Jacarepaguá)',3658),
	 ('Galeão',3658),
	 ('Gamboa',3658),
	 ('Gardênia Azul',3658),
	 ('Gávea',3658),
	 ...
	 ('Jacarezinho',3658),
	 ('Jardim América',3658),
	 ('Jardim Botânico',3658),
	 ('Jardim Carioca',3658),
	 ('Jardim Guanabara',3658),
	 ('Jardim Sulacap',3658),
	 ...
	 ('Leblon',3658),
	 ('Leme',3658),
	 ('Lins de Vasconcelos',3658),
	 ('Madureira',3658),
	 ('Magalhães Bastos',3658),
	 ('Mangueira',3658),
	 ('Manguinhos',3658),

	 ('Maracanã',3658),
	 ('Maré',3658),
	 ('Marechal Hermes',3658),
	 ('Maria da Graça',3658),
	 ('Méier',3658),
	 ('Moneró',3658),
	 ('Olaria',3658),
	 ...
	 ('Paquetá',3658),
	 ('Parada de Lucas',3658),
	 ('Parque Anchieta',3658),
	 ('Parque Columbia',3658),
	 ('Pavuna',3658),
	 ('Pechincha',3658),
	 ('Pedra de Guaratiba',3658),
	 ('Penha',3658),
	 ('Penha Circular',3658),
	 ('Piedade',3658),
	 ...
	 ('Pitangueiras',3658),
	 ('Portuguesa',3658),
	 ('Praça da Bandeira',3658),
	 ('Praça Seca',3658),
	 ('Praia da Bandeira',3658),
	 ('Quintino Bocaiúva',3658),
	 ('Ramos',3658),
	 ('Realengo',3658),
	 ('Recreio dos Bandeirantes',3658),

	 ('Riachuelo',3658),
	 ('Ribeira',3658),
	 ('Ricardo de Albuquerque',3658),
	 ('Rio Comprido',3658),
	 ('Rocha',3658),
	 ('Rocha Miranda',3658),
	 ('Rocinha',3658),
	 ...
	 ('São Conrado',3658),
	 ('São Cristóvão',3658),
	 ('São Francisco Xavier',3658),
	 ('Saúde',3658),
	 ('Senador Camará',3658),
	 ('Senador Vasconcelos',3658),
	 ('Sepetiba',3658),
	 ('Tanque',3658),
	 ...
	 ('Eucaliptal',3682),
	 ('Jardim Amália',3682),
	 ('Jardim Belmonte',3682),
	 ('Jardim Belvedere',3682),
	 ('Jardim Europa',3682),

	 ('Jardim Padre Josimo Tavares',3682),
	 ('Jardim Paraíba',3682),
	 ('Jardim Suiça',3682),
	 ('Laranjal',3682),
	 ('Minerlândia',3682),
	 ...
	 ('Santa Cruz II',3682),
	 ('Santa Inês',3682),
	 ('Santa Rita do Zarur',3682),
	 ('Santo Agostinho',3682),
	 ('São Cristóvão',3682),
	 ('São Geraldo',3682),
	 ('São João',3682),

	 ('São João Batista',3682),
	 ('São Lucas',3682),
	 ('São Luís',3682),
	 ('Sessenta',3682),
	 ('Siderlândia',3682),
	 ...
	 ('Vila Rica',3682),
	 ('Vila Santa Cecília',3682),
	 ('Voldac',3682),
	 ('Altos de Anhembi',4731),
	 ('Centro',4731),
	 ('Centro (Pirambóia)',4731),
	 ('Distrito Industrial',4731),
	 ('Jardim Bandeirantes',4731),
	 ('Jardim Cruzeiro',4731),
	 ('Jardim Nova Anhembi',4731),

	 ('Jardim Nova Pirambóia',4731),
	 ('Morada do Sol',4731),
	 ('Nossa Senhora das Graças',4731),
	 ('Nossa Senhora dos Navegantes',4731),
	 ('Recanto da Figueira',4731),
	 ('Vila São José',4731),
	 ('Água Espraiada',4753),
	 ('Alvinópolis',4753),
	 ('Boa Vista',4753),
	 ...
	 ('Ribeirão dos Porcos',4753),
	 ('Rio Abaixo',4753),
	 ('Rosário',4753),
	 ('São João das Pitas',4753),
	 ('Tanque',4753),
	 ('Usina',4753),
	 ('Aldeia',4770),
	 ('Aldeia da Serra',4770),
	 ('Alphaville',4770),
	 ('Altos',4770),
	 ...
	 ('Votupoca',4770),
	 ('Centro',4774),
	 ('Chácaras Parati',4774),
	 ('Distrito Industrial I',4774),
	 ('Distrito Industrial II',4774),
	 ('Estância Vila Verde',4774),
	 ('Jardim Alvorada',4774),
	 ('Jardim Califórnia',4774),
	 ('Jardim Canadá',4774),

	 ('Jardim Casa Grande',4774),
	 ('Jardim Ciranda',4774),
	 ('Jardim Cláudia I',4774),
	 ('Jardim Cláudia II',4774),
	 ('Jardim das Acácias',4774),
	 ('Jardim das Laranjeiras',4774),
	 ('Jardim de Lúcia',4774),
	 ('Jardim do Bosque',4774),
	 ('Jardim do Sonho',4774),
	 ('Jardim Esplanada',4774),

	 ('Jardim Estoril',4774),
	 ('Jardim Júlia',4774),
	 ('Jardim Marajá',4774),
	 ('Jardim Menino Deus I',4774),
	 ('Jardim Menino Deus II',4774),
	 ('Jardim Nossa Senhora Aparecida',4774),
	 ('Jardim Paraíso',4774),
	 ('Jardim Progresso',4774),
	 ('Jardim Sanderson',4774),
	 ('Jardim São Fernando',4774),

	 ('Jardim São João',4774),
	 ('Jardim São Sebastião',4774),
	 ('Jardim Talarico',4774),
	 ('Jardim Três Marias',4774),
	 ('Jardim Tropical',4774),
	 ('Parque Eldorado',4774),
	 ('Parque Residencial Irmãos Furquim',4774),
	 ('Parque Residencial Santo Antônio',4774),
	 ('Pioneiro',4774),
	 ('Residencial Antônia Santaella',4774),

	 ('Residencial Bebedouro',4774),
	 ('Residencial Centenário',4774),
	 ('Residencial Doutor Pedro Paschoal',4774),
	 ('Residencial Franciscano',4774),
	 ('Residencial Hercules Pereira Hortal',4774),
	 ('Residencial Parati I',4774),
	 ('Residencial Parati II',4774),
	 ('Residencial Pedro Maia',4774),
	 ('Residencial Rassim Dibe',4774),
	 ('Residencial San Conrado',4774),

	 ('Residencial São Carlos',4774),
	 ('Residencial São Francisco',4774),
	 ('Residencial Souza Lima',4774),
	 ('Residencial União',4774),
	 ('Residencial Vale do Sol',4774),
	 ('Vila Aeroporto',4774),
	 ('Vila Alto do Sumaré',4774),
	 ('Vila Cruzeiro',4774),
	 ('Vila Elizabeth',4774),
	 ('Vila Irmã Antonieta Farani',4774),

	 ('Vila Major Cícero de Carvalho',4774),
	 ('Vila Novo Lar',4774),
	 ('Vila Paula',4774),
	 ('Vila Paulista',4774),
	 ('Vila Santa Terezinha',4774),
	 ('AA',4784),
	 ('AB',4784),
	 ('AC',4784),
	 ('AD',4784),
	 ...
	 ('Centro Empresarial Castello Branco',4784),
	 ('Chácara dos Pinhais',4784),
	 ('Colina Nova Boituva',4784),
	 ('Green Ville',4784),
	 ('Jardim América',4784),
	 ('Jardim das Palmeiras',4784),
	 ('Jardim Egídio Labronici',4784),
	 ('Jardim Flamboyant',4784),
	 ('Jardim Oreana',4784),
	 ('Jardim Parque Ecológico',4784),

	 ('Jardim Santa Adélia',4784),
	 ('Jardim São Paulo',4784),
	 ('Jardim Valparaíso',4784),
	 ('Parque Ecológico',4784),
	 ('Parque Nossa Senhora das Graças',4784),
	 ('Parque Novo Mundo',4784),
	 ('Parque Residencial Esplanada',4784),
	 ('Portal dos Pássaros',4784),
	 ('Rancho dos Arcos',4784),
	 ('Recanto Maravilha',4784),

	 ('Residencial Del Lorenzi',4784),
	 ('Residencial Flora Ville',4784),
	 ('Residencial Vitória',4784),
	 ('Terras de Santa Cruz',4784),
	 ('Vila Nossa Senhora Aparecida',4784),
	 ('Vitassay',4784),
	 ('Vivendas do Parque',4784),
	 ('Água Comprida',4792),
	 ('América',4792),
	 ('Aparecida',4792),
	 ...
	 ('Menin',4792),
	 ('Morro Grande',4792),
	 ('Morro Grande da Boa Vista',4792),
	 ('Morro Verde',4792),
	 ('Mourão',4792),
	 ('Palmeiras',4792),
	 ...
	 ('Vera Tereza',4807),
	 ('Vila Rosina',4807),
	 ('Altos do Higienópolis',4832),
	 ('Bairro do Km Sete',4832),

	 ('Cecap (Conjunto Habitacional José A. Borelli)',4832),
	 ('Centro',4832),
	 ('Conjunto Antônio Mastrocola',4832),
	 ('Conjunto Habitacional Ângelo Gavioli',4832),
	 ('Conjunto Habitacional Antônio Zaccaro',4832),
	 ('Conjunto Habitacional Euclides Figueiredo',4832),
	 ('Conjunto Habitacional Gabriel Hernandes',4832),
	 ('Conjunto Habitacional Nair de Freitas',4832),
	 ('Conjunto Habitacional Pedro Luis Boso/Manoel',4832),
	 ('Conjunto Habitacional Pedro Nechar',4832),

	 ('Conjunto Habitacional Prefeito João Righini',4832),
	 ('Distrito Industrial Antônio Zaccaro',4832),
	 ('Distrito Industrial José Antônio Boso',4832),
	 ('Distrito Industrial Pedro Luis Boso',4832),
	 ('Expansão 1',4832),
	 ('Expansão 2',4832),
	 ('Expansão 3',4832),
	 ('Granville I',4832),
	 ...
	 ('Jardim Alpino',4832),
	 ('Jardim Alvorada',4832),
	 ('Jardim Amêndola',4832),
	 ('Jardim América',4832),
	 ('Jardim Bela Vista',4832),
	 ('Jardim Belém',4832),
	 ('Jardim Bom Pastor',4832),
	 ('Jardim Brasil',4832),
	 ('Jardim Caparroz',4832),
	 ('Jardim Clélia',4832),

	 ('Jardim da Torre',4832),
	 ('Jardim Del Rey',4832),
	 ('Jardim do Bosque',4832),
	 ('Jardim do Lago',4832),
	 ('Jardim dos Coqueiros',4832),
	 ('Jardim dos Coqueiros II',4832),
	 ('Jardim Eldorado',4832),
	 ('Jardim Esperança',4832),
	 ('Jardim Imperial',4832),
	 ('Jardim Ipanema',4832),

	 ('Jardim Irradiação',4832),
	 ('Jardim Júlia Caparroz',4832),
	 ('Jardim Monte Líbano',4832),
	 ('Jardim Moreschi',4832),
	 ('Jardim Nações Unidas',4832),
	 ('Jardim Oriental',4832),
	 ('Jardim Pedro Borgonovi',4832),
	 ('Jardim Primavera',4832),
	 ('Jardim Salles',4832),
	 ('Jardim Santa Helena',4832),

	 ('Jardim Santa Rosa',4832),
	 ('Jardim São Domingos',4832),
	 ('Jardim Shangri-lá',4832),
	 ('Jardim Soto',4832),
	 ('Jardim Tarraf II',4832),
	 ('Jardim Vertoni',4832),
	 ('Loteamento Miguel Elias',4832),
	 ('Morada dos Executivos',4832),
	 ('Morada dos Pássaros',4832),
	 ('Nosso Teto',4832),

	 ('Nova Catanduva',4832),
	 ('Parque Flamingo',4832),
	 ('Parque Glória I',4832),
	 ('Parque Glória II',4832),
	 ('Parque Glória III',4832),
	 ('Parque Glória IV',4832),
	 ('Parque Glória V',4832),
	 ('Parque Glória VI',4832),
	 ('Parque Ipiranga',4832),
	 ('Parque Iracema',4832),

	 ('Parque Joaquim Lopes',4832),
	 ('Parque Residencial Agudo Romão',4832),
	 ('Polo Coml. e Indl. Raul de Carvalho',4832),
	 ('Polo Industrial Giordano Mestrinelli',4832),
	 ('Residencial Agudo Romão 2',4832),
	 ('Residencial Cidade Jardim',4832),
	 ('Residencial Colina do Sol',4832),
	 ('Residencial Diolfen Martani',4832),
	 ('Residencial Esplanada',4832),
	 ('Residencial Isabela',4832),

	 ('Residencial Juliatti de Carvalho',4832),
	 ('Residencial Maria Luiza Peres de Faria',4832),
	 ('Residencial Pacha',4832),
	 ('Residencial Paraíso',4832),
	 ('Residencial Pedro Monteleone',4832),
	 ('Residencial Primavera',4832),
	 ('Residencial San Remo',4832),
	 ('Residencial Santa Paula',4832),
	 ('Residencial Sebastião Moraes',4832),
	 ('São Francisco',4832),

	 ('Solo Sagrado',4832),
	 ('Vila Alexandria',4832),
	 ('Vila Bela',4832),
	 ('Vila Celso Mouad',4832),
	 ('Vila Engracia',4832),
	 ('Vila Guzzo',4832),
	 ('Vila Industrial',4832),
	 ('Vila Jorge',4832),
	 ('Vila Juca Pedro',4832),
	 ('Vila Lunardelli',4832),

	 ('Vila Maria Jorge',4832),
	 ('Vila Mota',4832),
	 ('Vila Paulista',4832),
	 ('Vila Rodrigues',4832),
	 ('Vila Santo Antônio',4832),
	 ('Vila São Luís',4832),
	 ('Vila Stocco',4832),
	 ('Zé Povão',4832),
	 ('Areais',4856),
	 ...
	 ('Centro',4856),
	 ('Cota 200',4856),
	 ('Cruzeiro Quinhentista',4856),
	 ('Guará-Vermelho',4856),
	 ('Ilha Caraguatá',4856),
	 ('Ilha do Tatu',4856),
	 ('Ilha Nhapium',4856),
	 ('Ilha Pompeva',4856),
	 ('Itutinga-Pilões',4856),
	 ('Jardim Anchieta',4856),

	 ('Jardim Casqueiro',4856),
	 ('Jardim Nova República',4856),
	 ('Jardim São Francisco',4856),
	 ('Mãe Maria',4856),
	 ('Marzagão',4856),
	 ('Paranhos',4856),
	 ('Parque Cotia-Pará',4856),
	 ('Parque Perequê',4856),
	 ('Parque São Luis',4856),
	 ('Perequê',4856),

	 ('Piaçaguera',4856),
	 ('Pinhal do Miranda',4856),
	 ('Raiz da Serra',4856),
	 ('Santa Rosa',4856),
	 ('Serra do Mogi',4856),
	 ('Serra do Mourão',4856),
	 ('Serra do Poço do Meio',4856),
	 ('Serra Pilões-Zangalá',4856),
	 ('Sítio Cafezal',4856),
	 ('Vale Verde',4856),

	 ('Vila Couto',4856),
	 ('Vila dos Pescadores',4856),
	 ('Vila Elizabeth',4856),
	 ('Vila Esperança',4856),
	 ('Vila Fabril',4856),
	 ('Vila Light',4856),
	 ...
	 ('Bosque Capuava',4874),
	 ('Bosque do Embu',4874),
	 ('Caminho do Índio',4874),
	 ('Capuava',4874),
	 ('Centro',4874),
	 ('Cercado Grande',4874),
	 ('Chacaras Ana Lucia',4874),

	 ('Chacaras Aurora',4874),
	 ('Chacaras Bartira',4874),
	 ('Chacaras Lidia',4874),
	 ('Chacaras São Cristovão',4874),
	 ('Cooperativa',4874),
	 ('Embu Colonial',4874),
	 ('Embu-Mirim',4874),
	 ('Embuema',4874),
	 ...
	 ('Estância de Embuarama',4874),
	 ('Gramado',4874),
	 ('Granja Nossa Senhora Aparecida',4874),
	 ('Invernada',4874),
	 ('Itatuba',4874),
	 ('Jardim Ângela',4874),
	 ('Jardim Batista',4874),
	 ('Jardim Casa Branca',4874),
	 ('Jardim Castilho',4874),
	 ('Jardim Colibri',4874),

	 ('Jardim da Luz',4874),
	 ('Jardim de Lourdes',4874),
	 ('Jardim do Colégio',4874),
	 ('Jardim Dom José',4874),
	 ('Jardim dos Ipes',4874),
	 ('Jardim dos Moraes',4874),
	 ('Jardim dos Oliveiras',4874),
	 ('Jardim Elisa',4874),
	 ('Jardim Fabiana',4874),
	 ('Jardim Ferreira',4874),

	 ('Jardim Flórida',4874),
	 ('Jardim Indaia',4874),
	 ('Jardim Independência',4874),
	 ('Jardim Irene',4874),
	 ('Jardim Itatiaia',4874),
	 ('Jardim Julia',4874),
	 ('Jardim Jurema',4874),
	 ('Jardim Laila',4874),
	 ('Jardim Lavorato',4874),
	 ('Jardim Magaly',4874),

	 ('Jardim Marina',4874),
	 ('Jardim Mimas',4874),
	 ('Jardim Nayara',4874),
	 ('Jardim Nossa Senhora de Fátima',4874),
	 ('Jardim Novo Campo Limpo',4874),
	 ('Jardim Novo Embu',4874),
	 ('Jardim Pinheirinho',4874),
	 ('Jardim Pinheiros',4874),
	 ('Jardim Presidente Kennedy',4874),
	 ('Jardim Recanto da Fonte',4874),

	 ('Jardim Sadie',4874),
	 ('Jardim Santa Bárbara',4874),
	 ('Jardim Santa Clara',4874),
	 ('Jardim Santa Emília',4874),
	 ('Jardim Santa Luzia',4874),
	 ('Jardim Santa Maria',4874),
	 ('Jardim Santa Rita',4874),
	 ('Jardim Santa Tereza',4874),
	 ('Jardim Santo Antonio',4874),
	 ('Jardim Santo Eduardo',4874),

	 ('Jardim São Francisco',4874),
	 ('Jardim São Luiz',4874),
	 ('Jardim São Marcos',4874),
	 ('Jardim Silvia',4874),
	 ('Jardim Taima',4874),
	 ('Jardim Tome',4874),
	 ('Jardim Valo Verde',4874),
	 ('Jardim Vazame',4874),
	 ('Jardim Vista Alegre',4874),
	 ('Jardim Vitória',4874),

	 ('Maranhão',4874),
	 ('Maria Auxiliadora',4874),
	 ('Maria Imaculada',4874),
	 ('Moinho Velho',4874),
	 ('Mundo Real',4874),
	 ('Paranapanema',4874),
	 ('Parque das Chácaras',4874),
	 ('Parque dos Caetes',4874),
	 ('Parque Francisco Rizzo',4874),
	 ('Parque Industrial',4874),

	 ('Parque Luiza',4874),
	 ('Parque Pirajussara',4874),
	 ('Parque São Leonardo',4874),
	 ('Pataxos',4874),
	 ('Pedreira',4874),
	 ('Perove',4874),
	 ('Pindorama',4874),
	 ...
	 ('Vila Bonfim',4874),
	 ('Vila Carmem',4874),
	 ('Vila Isis Cristina',4874),
	 ('Vila Olinda',4874),
	 ('Vila Pereque',4874),

	 ('Vila Real',4874),
	 ('Vila Regina',4874),
	 ('Vila Votorantim',4874),
	 ('Astúrias',4919),
	 ('Cachoeira',4919),
	 ('Conceiçãozinha',4919),
	 ('Enseada I',4919),
	 ...
	 ('Helena Maria',4919),
	 ('Itapema',4919),
	 ('Jardim Acapulco',4919),
	 ('Jardim Boa Esperança',4919),
	 ('Jardim Progresso',4919),
	 ('Jardim Virgínia 1',4919),
	 ('Jardim Virgínia 2',4919),
	 ('Mar e Céu',4919),
	 ('Marinas 1',4919),
	 ('Marinas 2',4919),
	 ...
	 ('Santo Antônio 1',4919),
	 ('Santo Antônio 2',4919),
	 ('Tombo',4919),
	 ('Tortuga',4919),
	 ('Vargem Grande',4919),
	 ('Vila Áurea',4919),
	 ('Vila Zilda',4919),
	 ('Aeroporto Internacional',4920),
	 ('Água Azul',4920),
	 ('Água Chata',4920),
	 ...
	 ('Itaím',4920),
	 ('Itapegica',4920),
	 ('Jardim Vila Galvão',4920),
	 ('Lavras',4920),
	 ('Macedo',4920),

	 ('Maia',4920),
	 ('Mato das Cobras',4920),
	 ('Monte Carmelo',4920),
	 ('Morro Grande',4920),
	 ('Morros',4920),
	 ('Paraventi',4920),
	 ...
	 ('Pimentas',4920),
	 ('Ponte Grande',4920),
	 ('Porto da Igreja',4920),

	 ('Presidente Dutra',4920),
	 ('Sadokim',4920),
	 ('São João',4920),
	 ('São Roque',4920),
	 ('Taboão',4920),
	 ...
	 ('Campos Elíseos',4960),
	 ('Centro',4960),
	 ('Cibratel - Chácaras',4960),
	 ('Cibratel I',4960),
	 ('Cibratel II',4960),
	 ('Cidade Anchieta',4960),
	 ('Corumbá',4960),

	 ('Do Rio Acima',4960),
	 ('Gaivota - Interior',4960),
	 ('Gaivota - Praia',4960),
	 ('Guapiranga',4960),
	 ('Guaraú',4960),
	 ('Guarda Civil',4960),
	 ('Ivoty',4960),
	 ('Jamaica - Interior',4960),
	 ('Jamaica - Praia',4960),
	 ('Jardim Anchieta',4960),

	 ('Jardim Coronel',4960),
	 ('Jardim Suarão - Interior',4960),
	 ('Jardim Suarão - Praia',4960),
	 ('Laranjeiras',4960),
	 ('Loty',4960),
	 ('Marrocos',4960),
	 ('Mosteiro',4960),
	 ('Nossa Senhora do Sion',4960),
	 ('Nova Itanhaém - Interior',4960),
	 ('Nova Itanhaém - Praia',4960),

	 ('Oásis',4960),
	 ('Praia dos Sonhos',4960),
	 ('Raminho',4960),
	 ('Sabaúna',4960),
	 ('São Fernando',4960),
	 ('Satélite',4960),
	 ...
	 ('Rio Abaixo',4972),
	 ('São Bento',4972),
	 ('Sítio Mato Dentro',4972),
	 ('Tipóia',4972),
	 ('Una',4972),
	 ('Vila Virgínia',4972),
	 ('Macrozona Destinação Industrial (Carv. Pinto - S. Silvestre)',4985),
	 ('Macrozona Destinação Industrial (MDI - AVIBRÁS)',4985),
	 ('Macrozona Destinação Industrial (MDI - Carvalho Pinto)',4985),

	 ('Macrozona Destinação Industrial (MDI - Meia Lua)',4985),
	 ('Macrozona Destinação Industrial (MDI - Pagador de Andrade)',4985),
	 ('Macrozona Destinação Industrial (MDI - Parateí)',4985),
	 ('Macrozona Destinação Industrial (MDI - São Silvestre)',4985),
	 ('Zona de Adensamento Controlado (ZAC - Meia Lua)',4985),
	 ('Zona de Adensamento Controlado (ZAC - São Silvestre)',4985),
	 ('Zona de Adensamento Controlado (ZAC)',4985),
	 ('Zona de Adensamento Restrito (ZAR)',4985),
	 ('Zona de Interesse Social',4985),
	 ('Zona Especial de Centro (ZEC)',4985),

	 ('Zona Especial de Várzea (ZEV)',4985),
	 ('Zona Preferencial 01 - ZAP 1',4985),
	 ('Zona Preferencial 02 - ZAP 2 A',4985),
	 ('Zona Preferencial 02 - ZAP 2 B',4985),
	 ('Aeroporto',5001),
	 ('Agapeama',5001),
	 ('Anhangabaú',5001),
	 ('Casa Branca / Setor Industrial',5001),
	 ('Caxumbu',5001),
	 ('Cecap',5001),

	 ('Centro',5001),
	 ('Cerâmica Ibetel',5001),
	 ('Colônia',5001),
	 ('Décimo Segundo GAC (Grupo de Artilharia e Campanha)',5001),
	 ('Distrito Industrial',5001),
	 ('Engordadouro',5001),
	 ('Ermida',5001),
	 ('Gramadão',5001),
	 ('Horto Florestal',5001),
	 ('Hortolândia',5001),

	 ('Jardim das Tulipas',5001),
	 ('Jardim do Lago',5001),
	 ('Jardim Nambi',5001),
	 ('Jardim Pacaembu',5001),
	 ('Jardim Samambaia',5001),
	 ('Jardim São Camilo',5001),
	 ('Jardim Tamoyo',5001),
	 ('Jundiaí Mirim',5001),
	 ('Malota',5001),
	 ('Marco Leite',5001),
	 ...
	 ('Moisés',5001),
	 ('Nova Odessa',5001),
	 ('Parque Centenário',5001),
	 ('Parque do Colégio',5001),
	 ('Parque Eloy Chaves',5001),
	 ('Pinheirinho/Represa',5001),
	 ('Ponte São João',5001),
	 ('Retiro',5001),
	 ('Setor Industrial',5001),

	 ('Torres de São José',5001),
	 ('Vale Azul',5001),
	 ('Vianelo/Bonfiglioli',5001),
	 ('Vila Alvorada',5001),
	 ('Vila Arens / Vila Progresso',5001),
	 ('Vila Maringá',5001),
	 ('Vila Municipal',5001),
	 ('Vila Rami',5001),
	 ('Vila Rio Branco',5001),
	 ('RP1 (Regiões de Planejamento)',5038),

	 ('RP10 (Regiões de Planejamento)',5038),
	 ('RP11 (Regiões de Planejamento)',5038),
	 ('RP12 (Regiões de Planejamento)',5038),
	 ('RP13 (Regiões de Planejamento)',5038),
	 ('RP14 (Regiões de Planejamento)',5038),
	 ('RP2 (Regiões de Planejamento)',5038),
	 ('RP3 (Regiões de Planejamento)',5038),
	 ('RP4 (Regiões de Planejamento)',5038),
	 ('RP5 (Regiões de Planejamento)',5038),
	 ('RP6 (Regiões de Planejamento)',5038),

	 ('RP7 (Regiões de Planejamento)',5038),
	 ('RP8 (Regiões de Planejamento)',5038),
	 ('RP9 (Regiões de Planejamento)',5038),
	 ('Adalgisa',5095),
	 ('Aliança',5095),
	 ('Ayrosa',5095),
	 ('Bandeiras',5095),
	 ...
	 ('Industrial Altino',5095),
	 ('Industrial Anhanguera',5095),
	 ('Industrial Autonomistas',5095),
	 ('Industrial Centro',5095),
	 ('Industrial Mazzei',5095),
	 ('Industrial Remédios',5095),
	 ('Jaguaribe',5095),
	 ('Jardim Conceição',5095),
	 ('Jardim D''Abril',5095),
	 ('Jardim das Flores',5095),

	 ('Jardim Elvira',5095),
	 ('Jardim Novo Osasco',5095),
	 ('Jardim Roberto',5095),
	 ('Km 18',5095),
	 ('Metalúrgicos',5095),
	 ('Munhoz Júnior',5095),
	 ...
	 ('Padroeira',5095),
	 ('Paiva Ramos',5095),
	 ('Parque Continental',5095),

	 ('Pestana',5095),
	 ('Piratininga',5095),
	 ('Platina',5095),
	 ('Portal D''Oeste',5095),
	 ('Presidente Altino',5095),
	 ('Quintauna',5095),
	 ('Raposo Tavares',5095),
	 ('Remédios',5095),
	 ('Rochale',5095),
	 ...
	 ('Conceição',5141),
	 ('Dois Córregos',5141),
	 ('Glebas Califórnia',5141),
	 ('Guamium',5141),
	 ('Higienópolis',5141),
	 ('Jaraguá',5141),
	 ('Jardim Califórnia',5141),
	 ('Jardim Caxambú',5141),
	 ('Jardim Elite',5141),
	 ('Jardim Itapuã',5141),
	 ('Jardim Jupiá',5141),
	 ('Jardim Monumento',5141),
	 ('Jardim Planalto',5141),
	 ('Jardim Primavera',5141),
	 ('Jardim São Francisco',5141),
	 ('Mário Dedini',5141),
	 ('Monte Alegre',5141),
	 ('Monte Líbano',5141),
	 ('Morato',5141),
	 ...
	 ('Nhô Quim',5141),
	 ('Nova América',5141),
	 ('Nova Piracicaba',5141),
	 ('Novo Horizonte',5141),
	 ('Ondas',5141),
	 ('Ondinhas',5141),
	 ('Parque da Rua do Porto',5141),
	 ('Parque Residencial Piracicaba',5141),
	 ('Paulicéia',5141),
	 ('Paulista',5141),
	 ('Piracicamirim',5141),
	 ('Pompéia',5141),
	 ...
	 ('Vila Cristina',5141),
	 ('Vila Fátima',5141),
	 ('Vila Independência',5141),
	 ('Vila Industrial',5141),
	 ('Vila Monteiro',5141),
	 ('Vila Rezende',5141),
	 ('Vila Sônia',5141),
	 ('Andaraguá',5167),
	 ...
	 ('Centro',5194),
	 ('Centro Alto',5194),
	 ('Centro Ouro Fino Paulista',5194),
	 ('Colônia',5194),
	 ('Guapituba',5194),
	 ('Itrapoã',5194),
	 ('Km 4',5194),
	 ...
	 ('(S-8)',5195),
	 ('(S-9)',5195),
	 ('Setor Central - C',5195),
	 ('Subsetor Leste - 1 (L-1)',5195),
	 ('Subsetor Leste - 2 (L-2)',5195),
	 ('Subsetor Leste - 3 (L-3)',5195),
	 ('Subsetor Leste - 4 (L-4)',5195),
	 ('Subsetor Leste - 5 (L-5)',5195),
	 ('Subsetor Leste - 6 (L-6)',5195),
	 ('Subsetor Leste - 7 (L-7)',5195),
	 ('Subsetor Leste - 8 (L-8)',5195),
	 ('Subsetor Norte - 1 (N-1)',5195),
	 ('Subsetor Norte - 10 (N-10)',5195),
	 ('Subsetor Norte - 11 (N-11)',5195),
	 ('Subsetor Norte - 12 (N-12)',5195),
	 ('Subsetor Norte - 13 (N-13)',5195),
	 ('Subsetor Norte - 14 (N-14)',5195),
	 ('Subsetor Norte - 2 (N-2)',5195),
	 ('Subsetor Norte - 3 (N-3)',5195),
	 ('Subsetor Norte - 4 (N-4)',5195),
	 ('Subsetor Norte - 5 (N-5)',5195),
	 ('Subsetor Norte - 6 (N-6)',5195),
	 ('Subsetor Norte - 7 (N-7)',5195),
	 ('Subsetor Norte - 8 (N-8)',5195),
	 ('Subsetor Norte - 9 (N-9)',5195),
	 ('Subsetor Oeste - 1 (O-1)',5195),
	 ('Subsetor Oeste - 10 (O-10)',5195),
	 ('Subsetor Oeste - 11 (N-11)',5195),
	 ('Subsetor Oeste - 12 (O-12)',5195),
	 ('Subsetor Oeste - 2 (O-2)',5195),
	 ('Subsetor Oeste - 3 (O-3)',5195),
	 ('Subsetor Oeste - 4 (O-4)',5195),
	 ('Subsetor Oeste - 5 (O-5)',5195),
	 ('Subsetor Oeste - 6 (O-6)',5195),
	 ('Subsetor Oeste - 7 (O-7)',5195),
	 ('Subsetor Oeste - 8 (O-8)',5195),
	 ('Subsetor Oeste - 9 (O-9)',5195),
	 ('Subsetor Sul - 1 (S-1)',5195),
	 ('Subsetor Sul - 2 (S-2)',5195),
	 ('Subsetor Sul - 3 (S-3)',5195),
	 ('Subsetor Sul - 4 (S-4)',5195),
	 ('Subsetor Sul - 5 (S-5)',5195),
	 ('Subsetor Sul - 6 (S-6)',5195),
	 ('Subsetor Sul - 7 (S-7)',5195),
	 ('Acampamento Anchieta',5242),
	 ('Bairro Silveira',5242),
	 ('Bangú',5242),
	 ('Cabeceiras do Araçaúva',5242),
	 ('Cabeceiras do Rio Grande',5242),
	 ('Cabeceiras do Rio Mogi',5242),
	 ('Cabeceiras do Rio Pequeno',5242),
	 ('Campestre',5242),
	 ('Campo Grande',5242),
	 ('Casa Branca',5242),
	 ('Cata Preta',5242),
	 ('Centro',5242),
	 ('Cidade São Jorge',5242),
	 ('Condomínio Maracanã',5242),
	 ('Estância Rio Grande',5242),
	 ('Fazenda dos Tecos',5242),
	 ('Jardim',5242),
	 ('Jardim Alvorada',5242),
	 ('Jardim Alzira Franco',5242),
	 ('Jardim Ana Maria',5242),
	 ('Jardim Bela Vista',5242),
	 ('Jardim Bom Pastor',5242),
	 ('Jardim Clube de Campo',5242),
	 ('Jardim Cristiane',5242),
	 ('Jardim das Maravilhas',5242),
	 ('Jardim do Estádio',5242),
	 ('Jardim Guaripocaba',5242),
	 ('Jardim Ipanema',5242),
	 ('Jardim Irene',5242),
	 ('Jardim Itapoam',5242),
	 ('Jardim João Ramalho',5242),
	 ('Jardim Joaquim Eugênio de Lima',5242),
	 ('Jardim Marek',5242),
	 ('Jardim Rina',5242),
	 ('Jardim Riviera',5242),
	 ('Jardim Santa Cristina',5242),
	 ('Jardim Santo Alberto',5242),
	 ('Jardim Santo André',5242),
	 ('Jardim Santo Antônio',5242),
	 ('Jardim Stella',5242),
	 ('Jardim Utinga',5242),
	 ('Jardins Las Vegas',5242),
	 ('Paraíso',5242),
	 ('Paranapiacaba',5242),
	 ('Parque América',5242),
	 ('Parque Capuava',5242),
	 ('Parque das Garças',5242),
	 ('Parque das Nações',5242),
	 ('Parque do Pedroso',5242),
	 ('Parque dos Pássaros',5242),
	 ('Parque Erasmo Assunção',5242),
	 ('Parque Estadual da Serra do Mar',5242),
	 ('Parque Gerassi Centreville',5242),
	 ('Parque Jaçatuba',5242),
	 ('Parque João Ramalho',5242),
	 ('Parque Marajoara',5242),
	 ('Parque Miami',5242),
	 ('Parque Novo Oratório',5242),
	 ('Parque Oratório',5242),
	 ('Parque Represa Billings II',5242),
	 ('Parque Represa Billings III',5242),
	 ('Parque Rio Grande',5242),
	 ('Pólo Petroquímico de Capuava',5242),
	 ('Recreio da Borda do Campo',5242),
	 ('Reserva Biológica Alto da Serra',5242),
	 ('Rio Grande',5242),
	 ('Santa Maria',5242),
	 ('Santa Terezinha',5242),
	 ('Sítio dos Vianas',5242),
	 ('Sítio Taquaral',5242),
	 ('Tamanduateí 1',5242),
	 ('Tamanduateí 2',5242),
	 ('Tamanduateí 3',5242),
	 ...
	 ('Vila Assunção',5242),
	 ('Vila Bastos',5242),
	 ('Vila Camilópolis',5242),
	 ('Vila Curuçá',5242),
	 ('Vila Floresta',5242),
	 ('Vila Francisco Matarazzo',5242),
	 ('Vila Gilda',5242),
	 ('Vila Guaraciaba',5242),
	 ('Vila Guarani',5242),
	 ('Vila Guiomar',5242),
	 ('Vila Helena',5242),
	 ('Vila Homero Thon',5242),
	 ('Vila Humaitá',5242),
	 ('Vila Junqueira',5242),
	 ('Vila Linda',5242),
	 ('Vila Lucinda',5242),
	 ('Vila Lutécia',5242),
	 ('Vila Luzita',5242),
	 ('Vila Metalúrgica',5242),
	 ('Vila Palmares',5242),
	 ('Vila Pires',5242),
	 ('Vila Príncipe de Gales',5242),
	 ('Vila Progresso',5242),
	 ('Vila Sacadura Cabral',5242),
	 ('Vila Scarpelli',5242),
	 ('Vila Suíça',5242),
	 ('Vila Tibiriçá',5242),
	 ('Vila Valparaíso',5242),
	 ('Waisberg I',5242),
	 ('Waisberg II',5242),
	 ('Alemoa',5250),
	 ('Aparecida',5250),
	 ...
	 ('Monte Cabrão',5250),
	 ('Monte Serrat',5250),
	 ('Morro Cachoeira',5250),
	 ('Morro Caneleira',5250),
	 ('Morro Chico de Paula',5250),
	 ('Morro Embaré',5250),
	 ('Morro Fontana',5250),
	 ('Morro Jabaquara',5250),
	 ('Morro José Menino',5250),
	 ('Morro Marapé',5250),
	 ('Morro Nova Cintra',5250),
	 ('Morro Pacheco',5250),
	 ('Morro Penha',5250),
	 ('Morro Saboó',5250),
	 ('Morro Santa Maria',5250),
	 ('Morro Santa Terezinha',5250),
	 ('Morro São Bento',5250),
	 ('Nossa Senhora das Neves',5250),
	 ('Outerinho',5250),
	 ('Paquetá',5250),
	 ('Piratininga',5250),
	 ('Pompéia',5250),
	 ...
	 ('Jordanópolis',5252),
	 ('Montanhão',5252),
	 ('Nova Petrópolis',5252),
	 ('Paulicéia',5252),
	 ('Planalto',5252),
	 ('Rio Grande',5252),
	 ('Rudge Ramos',5252),
	 ('Santa Terezinha',5252),
	 ('Taboão',5252),
	 ('Barcelona',5253),
	 ('Boa Vista',5253),
	 ('Centro',5253),
	 ...
	 ('Santo Antônio',5253),
	 ('São José',5253),
	 ('Setor Socioeconômico 01',5265),
	 ('Setor Socioeconômico 01A',5265),
	 ('Setor Socioeconômico 02',5265),
	 ('Setor Socioeconômico 02A',5265),
	 ('Setor Socioeconômico 03',5265),
	 ('Setor Socioeconômico 03A',5265),
	 ('Setor Socioeconômico 04',5265),
	 ('Setor Socioeconômico 05',5265),
	 ('Setor Socioeconômico 05A',5265),
	 ('Setor Socioeconômico 06',5265),
	 ('Setor Socioeconômico 06A',5265),
	 ('Setor Socioeconômico 07',5265),
	 ('Setor Socioeconômico 08',5265),
	 ('Setor Socioeconômico 09',5265),
	 ('Setor Socioeconômico 10',5265),
	 ('Setor Socioeconômico 11',5265),
	 ('Setor Socioeconômico 12',5265),
	 ('Setor Socioeconômico 13',5265),
	 ('Setor Socioeconômico 14',5265),
	 ('Setor Socioeconômico 15',5265),
	 ('Setor Socioeconômico 16',5265),
	 ('Setor Socioeconômico 17',5265),
	 ('Setor Socioeconômico 17A',5265),
	 ('Setor Socioeconômico 18',5265),
	 ('Setor Socioeconômico 19',5265),
	 ('Setor Socioeconômico 20',5265),
	 ('Setor Socioeconômico 21',5265),
	 ('Setor Socioeconômico 25',5265),
	 ('Setor Socioeconômico 25A',5265),
	 ('Setor Socioeconômico 26',5265),
	 ('Setor Socioeconômico 27',5265),
	 ('Setor Socioeconômico 28',5265),
	 ('Setor Socioeconômico 29',5265),
	 ('Setor Socioeconômico 30',5265),
	 ('Setor Socioeconômico 31',5265),
	 ('Arrastão',5274),
	 ('Baleia',5274),
	 ('Barequeçaba',5274),
	 ('Barra do Sahy',5274),
	 ...
	 ('São Francisco',5274),
	 ('Topolândia',5274),
	 ('Toque-Toque Grande',5274),
	 ('Toque-Toque Pequeno',5274),
	 ('Varadouro',5274),
	 ('Beira Mar',5277),
	 ('Boa Vista',5277),
	 ('Catiapoã',5277),
	 ('Centro',5277),
	 ('Cidade Náutica',5277),
	 ('Esplanada dos Barreiros',5277),
	 ('Gonzaguinha',5277),
	 ('Humaitá',5277),
	 ('Itararé',5277),
	 ('Japuí',5277),
	 ('Jardim Guassu',5277),
	 ('Jardim Independência',5277),
	 ('Jardim Irmã Dolores',5277),
	 ('Jardim Rio Branco',5277),
	 ('Jóckey Club',5277),
	 ('Nova São Vicente',5277),
	 ('Parque Bitaru',5277),
	 ('Parque Continental',5277),
	 ('Parque das Bandeiras',5277),
	 ('Parque São Vicente',5277),
	 ('Samarita',5277),
	 ('Sem Denominação',5277),
	 ('Vila Ema',5277),
	 ('Vila Margarida',5277),
	 ('Vila Melo',5277),
	 ('Vila Nossa Senhora de Fátima',5277),
	 ('Vila Nova Mariana',5277),
	 ('Vila São Jorge',5277),
	 ('Vila Valença',5277),
	 ('Vila Voturuá',5277),
	 ('Água Quente',5312),
	 ('Alto de São João',5312),
	 ('Alto de São Pedro',5312),
	 ('Areão',5312),
	 ('Barranco',5312),
	 ('Belém',5312),
	 ('Caixa d''Água',5312),
	 ...
	 ('Centro',5312),
	 ('Estiva',5312),
	 ('Imaculada Conceição',5312),
	 ('Independência',5312),
	 ('Itaim',5312),
	 ('Itapecerica',5312),
	 ('Lavadouro de Areia',5312),
	 ('Monção',5312),
	 ('Pinhão',5312),
	 ('Piracangaguá',5312),
	 ('Quiririm',5312),
	 ...
	 ('Almada',5329),
	 ('Barra da Lagoa',5329),
	 ('Barra Seca (Praias Vermelha e Alto)',5329),
	 ('Bela Vista',5329),
	 ('Camburi',5329),
	 ('Centro',5329),
	 ('Corcovado',5329),
	 ...
	 ('Estufa I',5329),
	 ('Estufa II',5329),
	 ('Figueira (Pé da Serra)',5329),
	 ('Flamengo/Praias: Ribeira e Sete Fortes',5329),
	 ('Folha Seca',5329),
	 ('Horto (Morro das Moças)',5329),
	 ('Ipiranguinha',5329),
	 ('Itaguá',5329),
	 ('Lagoinha',5329),
	 ('Lázaro (Praia Domingos Dias)',5329),
	 ('Marafunda',5329),
	 ('Maranduba',5329),
	 ('Monte Valério',5329),
	 ('Pedra Verde (Domingos Dias)',5329),
	 ('Pedreira',5329),
	 ('Pereque-Açu',5329),
	 ('Pereque-Mirim',5329),
	 ('Picinguaba',5329),
	 ('Ponta Grossa',5329),
	 ('Praia da Caçandoca (Pulso e Raposa)',5329),
	 ('Praia da Fazenda',5329),
	 ('Praia da Fortaleza',5329),
	 ('Praia da Porta (Lag Fig Galheta)',5329),
	 ('Praia do Félix (Praia do Lúcio)',5329),
	 ('Praia do Frade (Saco das Bananas)',5329),
	 ('Praia do Itamambuca',5329),
	 ('Praia do Puruba',5329),
	 ('Praia do Sapê',5329),
	 ('Praia Dura',5329),
	 ('Praia Grande',5329),
	 ('Praia Grande do Bonete (Praia Deserto)',5329),
	 ('Praia Vermelha',5329),
	 ('Promirim',5329),
	 ('Puruba',5329),
	 ('Ressaca',5329),
	 ('Rio da Prata',5329),
	 ('Rio Escuro',5329),
	 ('Saco da Ribeira (Praia do Lambert)',5329),
	 ('Santa Rita',5329),
	 ('Sertão da Quina',5329),
	 ('Sertão do Arariba',5329),
	 ('Sertão do Engenho Velho',5329),
	 ('Sertão do Ingá',5329),
	 ('Sertão do Meio',5329),
	 ('Sertão do Pereque-Mirim',5329),
	 ('Sesmaria',5329),
	 ('Silop',5329),
	 ('Sumaré',5329),
	 ('Sumidouro',5329),
	 ('Tabatinga',5329),
	 ('Taquaral',5329),
	 ('Tenório (Praia Vermelha)',5329),
	 ('Toninhas (Praias Godói  Xanda e Fora)',5329),
	 ('Mato Dentro (Carolina Trevo Samambá)',5329),
	 ('Ubatumirim',5329),
	 ('Umuarama',5329),
	 ('Água Rasa',5270),
	 ('Alto de Pinheiros',5270),
	 ('Anhanguera',5270),
	 ('Aricanduva',5270),
	 ('Artur Alvim',5270),
	 ('Barra Funda',5270),
	 ...
	 ('Cidade Líder',5270),
	 ('Cidade Líder',5270),
	 ('Cidade Tiradentes',5270),
	 ('Consolação',5270),
	 ('Cursino',5270),
	 ('Ermelino Matarazzo',5270),
	 ('Freguesia do Ó',5270),
	 ('Grajaú',5270),
	 ('Guaianases',5270),
	 ('Iguatemi',5270),
	 ...
	 ('Jardim Ângela',5270),
	 ('Jardim Helena',5270),
	 ('Jardim Paulista',5270),
	 ('Jardim São Luís',5270),
	 ('Lapa',5270),
	 ('Liberdade',5270),
	 ('Limão',5270),
	 ('Mandaqui',5270),
